...
func (t typeUtils) GetAddressInt(value int) *int {
	return &value
}

func (t typeUtils) ParseFloat(item interface{}) int {
	_item := item
	switch item.(type) {
	case int:
		return _item.(int)
...
func (t typeUtils) GetAddressFloat64(value float64) *float64 {
	return &value
}
...
func (t typeUtils) ToBytes(value interface{}) []byte {
